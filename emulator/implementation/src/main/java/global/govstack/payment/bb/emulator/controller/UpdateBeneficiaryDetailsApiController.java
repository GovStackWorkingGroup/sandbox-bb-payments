...
public class UpdateBeneficiaryDetailsApiController implements UpdateBeneficiaryDetailsApi {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(UpdateBeneficiaryDetailsApiController.class);
  ...
  public UpdateBeneficiaryDetailsApiController(
      ObjectMapper objectMapper, HttpServletRequest request) {
    this.objectMapper = objectMapper;
    this.request = request;
  }

  public ResponseEntity<InlineResponse200> updateBeneficiaryDetailsPost(
