...
public class PrepaymentValidationApiController implements PrepaymentValidationApi {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(PrepaymentValidationApiController.class);

  private final ObjectMapper objectMapper;

  private final HttpServletRequest request;

  @Autowired private CreditInstructionService creditInstructionService;
  ...
  public ResponseEntity<InlineResponse200> prepaymentValidationPost(
