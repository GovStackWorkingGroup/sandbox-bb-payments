...
import global.govstack.payment.bb.mock.dto.PrepaymentvalidationCreditInstructions;
...
public class PrepaymentvalidationBody   {
  ...
  public PrepaymentvalidationBody creditInstructions(List<PrepaymentvalidationCreditInstructions> creditInstructions) {
    this.creditInstructions = creditInstructions;
    return this;
  }

  public PrepaymentvalidationBody addCreditInstructionsItem(PrepaymentvalidationCreditInstructions creditInstructionsItem) {
  ...
  public void setCreditInstructions(List<PrepaymentvalidationCreditInstructions> creditInstructions) {
    this.creditInstructions = creditInstructions;
  }
