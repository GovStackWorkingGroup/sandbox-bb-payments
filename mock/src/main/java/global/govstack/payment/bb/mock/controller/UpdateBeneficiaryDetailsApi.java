...
public interface UpdateBeneficiaryDetailsApi {
    ...
    @ApiOperation(value = "Update beneficiary details", nickname = "updateBeneficiaryDetailsPost", notes = "", response = InlineResponse200.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<InlineResponse200> updateBeneficiaryDetailsPost(@ApiParam(value = "", required=true ) @Valid @RequestBody UpdatebeneficiarydetailsBody body);
